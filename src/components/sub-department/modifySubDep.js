...
import {patchSubDep} from '../../redux/actions/sub-departmentsActions'
...
console.log('filetoupdate:',{...Item,image: uploadedImage==undefined?props.item.image:uploadedImage})
      const result = await props.patchSubDep(props.item._id,{...Item,image: uploadedImage==undefined?props.item.image:uploadedImage})
...
export default connect(null, { patchSubDep })(ModifyItem);