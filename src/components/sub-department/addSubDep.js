...
import { saveSubDep } from '../../redux/actions/sub-departmentsActions'
...
const AddOrg = (props) => {
  ...
  const addDep = async (data, { resetForm }) => {
    ...
    let subDep = {
      ...data,
      image: uploadedImage,
      department:props.depId

    }
    console.log("news_Org to send to server:", subDep)
    const result = await props.saveSubDep(subDep)
                    ...
                    <Row>
                      ...
                      <Col xs="12" sm="12" lg="12">
                        ...
                        <Field
                          ...
                          placeholder="Nom de sous-département.."
                      ...
                      <Col xs="12" sm="12" lg="12">
                        <div className="mt-3 px-0 mx-0" style={{ height: "inherit" }}>
                          ...
                          <h5>Ajouter un logo pour ce sous-département : </h5>
...
export default connect(mapStateToProps, { saveSubDep })(AddOrg);