    ...
    return Uppy({
      ...
      .on('complete', result => {
        ...
        let el = result.successful[0]
          ...
          let idFile = el.uploadURL.slice(process.env.REACT_APP_UPPY_SLICE_NB)//
        ...
        dispatch({ type: props.typeDispatch, payload: image })
...
<Dialog
      ...
      >
        <DialogTitle id="alert-dialog-title" color="red">Téléchargement</DialogTitle>
        <DialogContent>
        < Dashboard
      uppy={uppy}
      inline={true}
