...
function AlertDialog(props) {
  ...
  const invalidateComment = async () => {
    setLoading(true);

    let newComment = { ...props.item, validatedByAdmin: false };
    let resp = await props.patchComment(
    ...
    if (resp) {
      ...
      await props.createNotification("invalid");
      setLoading(false);
      handleClose();
    }
  };
