...
setLoading(false)
  dispatch({type:"CLOSE_RESTORE"})
    ...
    <div>
      ...
      <Dialog
        open={props.openRestore}
        onClose={ handleClose}
        aria-labelledby="alert-dialog-title"
        aria-describedby="alert-dialog-description"
      >
        <DialogTitle id="alert-dialog-title" color="red">{props.infoRestore.title}</DialogTitle>
        <LoadingOverlay
        active={loading}
...
const mapStateToProps=(state)=>{
    return {
        openRestore:state.alertReducer.openRestore,
        infoRestore:state.alertReducer.infoRestore,
