          ...
          <div className="jr-card d-print-none">
            <Formik
              ...
              validationSchema={Yup.object().shape({
                ...
                phone: Yup.string().length(8,"Incorrect  format  n° tél!"),
                cin: Yup.string().length(8,"incorrect format CIN!"),
              ...
              render={({
                ...
                <Form>
                  <div style={{ maxWidth: 500 }} className='mx-auto'>
                    ...
                    <hr className="hr-text" data-content="Gérer mon compte" />
                    <Row>
                      ...
                      <Col mt-2 xs="12" sm="12" lg="12">
                        ...
                        />
                         <Field
                          ...
                          helperText={
                            errors.cin && touched.cin ? errors.cin : null
                          }
                        />
                      </Col>
                    </Row>
