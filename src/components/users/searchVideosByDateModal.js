...
const  DeleteVideo =(props)=> {
  ...
  const searchEvt=async(obj)=>{
   ...
   await props.getListVideosByDate(obj)
     //props.setAllowSearchByText(false)
    // props.render() // to force listEvents component to rerender
     setOpen(false);
  }else{
  ...
  return (
    <div>
      ...
      >
        ...
        <DialogTitle id="alert-dialog-title">{"Recherche par date d'inscription :"}</DialogTitle>
...
export default connect (mapStateToProps,{deleteOneVideoById})(DeleteVideo)