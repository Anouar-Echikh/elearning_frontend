...
const filterListUsers=(users)=>{
   ...
   let filtredList=users.filter((el)=>el.organization==props.profile.organization["_id"])
      let nonAffectedUsers=filtredList.filter((el)=>el.role=="user")
      return(nonAffectedUsers)
...
<div className="loader-view">
  ...
  return (
    ...
    <div className="w-100 d-flex flex-column justify-content-center " >
      <div className="m-2 container"  style={{fontSize:24, fontWeight:"bolder", color:"#666"}}>Utilisateurs non affectés</div>
